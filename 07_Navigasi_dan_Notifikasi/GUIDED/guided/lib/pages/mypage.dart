...
class Mypage extends StatelessWidget {
  ...
  final List<Product> products = [
    Product(
      ...
      deskripsi: 'Mouse Gaming yang mencapai akurasi sub-micron dengan zero smoothing, filtering, dan akselerasi.',
    ),
    Product(
      id: 2,
      ...
      deskripsi: 'MX Mechanical Wireless Illuminated Performance Keyboard',
    ),
    Product(
      id: 3,
