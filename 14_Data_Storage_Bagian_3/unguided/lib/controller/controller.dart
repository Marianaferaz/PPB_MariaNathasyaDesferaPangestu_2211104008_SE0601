...
class ApiController extends GetxController {
  ...
  void showSuccessSnackBar(String message) {
    Get.snackbar(
      'Success',
      message,
      backgroundColor: const Color.fromARGB(255, 247, 255, 140),
  ...
  Future<void> fetchPosts() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        showSuccessSnackBar('Berhasil mengambil data!');
      } else {
  ...
  Future<void> createPost() async {
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        showSuccessSnackBar('Yeay data kamu berhasil ditambahkan!');
      } else {
  ...
  Future<void> updatePost() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        showSuccessSnackBar('Kamu berhasil memperbarui data!');
      } else {
